    ...
    return {
        init: function( selectCb ) {
            uploader = new Uploader({
                ...
                server: './fileupload.php', ///[fengyuanchen/cropper(v.3.0.0)]配置
                swf: './webuploader/dist/Uploader.swf', ///[fengyuanchen/cropper(v.3.0.0)]配置
...
var Croper = (function() {
    ...
    function srcWrap( src, cb ) {
        ...
        if ( isBase64Supported ) {
            ...
            $.ajax('./preview.php', {   ///[fengyuanchen/cropper(v.3.0.0)]配置
                method: 'POST',
                data: src,
                dataType:'json'
